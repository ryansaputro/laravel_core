...
<style>
	...
	<div class="table-responsive">
		<table class="mdl-data-table table-bordered" id="myTable" style="width:100%">
			<thead>
				<tr>
					<th style="vertical-align: middle;" rowspan="3">No</th>
					<th style="vertical-align: middle;" rowspan="3">Kode Barang</th>
					<th style="vertical-align: middle;" rowspan="3">Nama Barang</th>
					<th style="vertical-align: middle;" rowspan="3">Harga Jual</th>
					<th style="vertical-align: middle;" rowspan="2" colspan="2">Persediaan Awal</th>
					<th style="vertical-align: middle;" rowspan="2" colspan="2">Penjualan</th>
					<th style="vertical-align: middle;" rowspan="2" colspan="2">Barang Masuk</th>
					<th style="vertical-align: middle;" colspan="2">Nilai Buku</th>
					<th style="vertical-align: middle;" colspan="2">Nilai Fisik</th>
					<th style="vertical-align: middle;" colspan="3">Hasil dari kegiatan stock opname</th>
				</tr>
				<tr>
					<th style="vertical-align: middle;" colspan="2">Persedian Akhir</th>
					<th style="vertical-align: middle;" colspan="2">Persedian Gudang</th>
					<th style="vertical-align: middle;" colspan="2">Selisih kurang/lebih</th>
