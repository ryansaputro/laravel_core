    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                ajaxUrl: 'http://127.0.0.1:8000/administrator/article',
                // ajaxUrl: '/ajax/upload',
                testMode: false
            }, options);
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button type="button" class="js-uploader__submit-button uploader__submit-button uploader__hide">' +
                ...
                secondarySelectButton: $('<input name="filesO[]" style="height: 0; width: 0;" id="secondaryfileinput' + index + '" type="file"' +
            ...
            function addItem (file) {
                ...
                var img = $('<input type="file" name="images[]" value="' + fileName + '">');
                // validate the file
