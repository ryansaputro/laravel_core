...
<form action="{{ route('pemesanan.store') }}" method="post" enctype="multipart/form-data">
	...
	<div class="form-group col-xs-3 col-md-3">
        ...
        <input type="text" value='{{$data->no_pemesanan}}' class="form-control" id="no_pemesanan" required name="no_pemesanan">
    </div>
    <div class="form-group col-xs-3 col-md-3"  style="border-right: 2px solid #ddd;">
        ...
        <input type="date" value="{{$data->dibuat_tgl}}" class="form-control" id="dibuat_tgl" required name="dibuat_tgl">
	</div>
	<div class="vl"></div>
	<div class="form-group col-xs-3 col-md-3">
